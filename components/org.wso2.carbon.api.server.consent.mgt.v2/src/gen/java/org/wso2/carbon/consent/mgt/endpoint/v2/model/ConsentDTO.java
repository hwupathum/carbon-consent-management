...
public enum StateEnum {
    ...
    **/
    ...
    @ApiModelProperty(example = "a1b2c3d4-1234-5678-abcd-ef1234567890", value = "ID of the user giving consent")
    ...
    **/
    public ConsentDTO properties(List<KeyValuePair> properties) {
    ...
    public ConsentDTO addPropertiesItem(KeyValuePair propertiesItem) {
