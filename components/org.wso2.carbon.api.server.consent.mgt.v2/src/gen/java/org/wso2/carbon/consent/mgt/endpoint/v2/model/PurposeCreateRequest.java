...
public class PurposeCreateRequest  {
 ...
 @Size(min=1,max=255)
    ...
    **/
    ...
    @ApiModelProperty(example = "Core Identity", required = true, value = "Purpose type classification")
    @JsonProperty("type")
    @Valid
 ...
 @Size(max=255)
    ...
    **/
    ...
    @ApiModelProperty(example = "v1.0", value = "Optional initial version label for the purpose (e.g., \"v1.0\")")
    ...
    **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, description, type, version, elements);
    }
