...
public class ConsentsApiServiceImplTest {
    ...
    public void testConsentsCreate() {
        ...
        purposeBinding.setElements(Collections.singletonList(elementInfo));

        ConsentCreateRequest request = new ConsentCreateRequest();
        request.setServiceId("test-service");
        request.setLanguage("EN");
        request.setPurposes(Collections.singletonList(purposeBinding));
    ...
    public void testConsentsCreate_withAuthz_subjectIdFromRequest() {
        ...
        request.setAuthorizations(Collections.singletonList("admin"));
    ...
    public void testConsentsAuthorize_approve_returns201() {
        ...
        UUID[] ids = createPurposeWithElement();
        ConsentCreateRequest request = buildConsentRequest(ids[0], ids[1]);
        request.setAuthorizations(Collections.singletonList("admin")); // calling user must be in authz list
    ...
    public void testVersionsDelete_withConsent_returns409() {
        ...
        consentReq.setPurposes(Collections.singletonList(purposeBinding));
    ...
    public void testConsentsRevoke_withAuthz_callerInList_success() {
        ...
        UUID[] ids = createPurposeWithElement();
        ConsentCreateRequest request = buildConsentRequest(ids[0], ids[1]);
        request.setAuthorizations(Collections.singletonList("admin")); // calling user is "admin"
    ...
    public void testConsentsRevoke_withAuthz_callerNotInList_returns403() {
        ...
        UUID[] ids = createPurposeWithElement();
        ConsentCreateRequest request = buildConsentRequest(ids[0], ids[1]);
        request.setAuthorizations(Collections.singletonList("other-user@test.com")); // "admin" is NOT in list
