...
public class ConsentManagerImplTest {
    ...
    public void testAddPurposeVersion() throws Exception {
        ...
        List<PurposeVersion> versions = consentManager.listPurposeVersions("00000000-0000-0000-0000-000000000001");
    ...
    public void testGetPurposeVersion() throws Exception {
        ...
        PurposeVersion added = consentManager.addPurposeVersion(1, version);

        PurposeVersion result = consentManager.getPurposeVersion("00000000-0000-0000-0000-000000000001", added.getUuid());
    ...
    public void testDeletePurposeVersion() throws Exception {
        ...
        PurposeVersion version = new PurposeVersion();
        version.setVersion("v1");
        consentManager.addPurposeVersion(1, version);

        PurposeVersion toDelete = new PurposeVersion();
        toDelete.setVersion("v2");
        PurposeVersion added = consentManager.addPurposeVersion(1, toDelete);

        consentManager.deletePurposeVersion("00000000-0000-0000-0000-000000000001", added.getUuid());
    ...
    public void testGetPurposeByUuid() throws Exception {
        ...
        Purpose purpose = consentManager.getPurposeByUuid("00000000-0000-0000-0000-000000000001");

        Assert.assertNotNull(purpose);
        Assert.assertEquals(purpose.getName(), "DEFAULT");
        Assert.assertEquals(purpose.getUuid(), "00000000-0000-0000-0000-000000000001");
    }
    ...
    public void testAddPurposeWithVersion() throws Exception {
        ...
        Object[] result = consentManager.addPurposeWithVersion(purpose, firstVersion);
