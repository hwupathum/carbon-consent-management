...
public class SQLConstants {
    ...
    public static final String GET_SP_PURPOSE_WITH_VERSION_SQL = "SELECT SP.ID,SP.CONSENT_TYPE," +
            ...
            "P.DESCRIPTION,P.ID,SP.PURPOSE_VERSION_ID,P.UUID FROM CM_SP_PURPOSE_ASSOC SP INNER JOIN CM_PURPOSE P " +
    ...
    public static final String GET_PII_CAT_WITH_UUID_SQL = "SELECT PC.NAME,PC.IS_SENSITIVE,SPC.VALIDITY," +
            "SPC.IS_CONSENTED,PC.ID,PC.DISPLAY_NAME,PC.UUID FROM CM_SP_PURPOSE_PII_CAT_ASSOC SPC INNER JOIN " +
            "CM_PII_CATEGORY PC ON SPC.PII_CATEGORY_ID = PC.ID WHERE SPC.SP_PURPOSE_ASSOC_ID =?";
    ...
    public static final String SEARCH_RECEIPT_SQL = "SELECT R.CONSENT_RECEIPT_ID, R.LANGUAGE, R.PII_PRINCIPAL_ID, R" +
            ...
            "CM_RECEIPT_SP_ASSOC RS ON R.CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? " +
            "ESCAPE '!' AND PRINCIPAL_TENANT_ID=? AND " +
            "SP_NAME LIKE ? ESCAPE '!' AND SP_TENANT_ID = ? AND STATE LIKE ? ORDER BY ID  ASC LIMIT ? OFFSET ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_DB2 = "SELECT CONSENT_RECEIPT_ID, LANGUAGE, PII_PRINCIPAL_ID, " +
            ...
            ".CONSENT_RECEIPT_ID = RS.CONSENT_RECEIPT_ID WHERE R.PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND " +
            "PRINCIPAL_TENANT_ID = ? AND RS.SP_NAME LIKE ? ESCAPE '!' AND RS" +
    ...
    public static final String SEARCH_RECEIPT_SQL_INFORMIX = "SELECT R.CONSENT_RECEIPT_ID, R.LANGUAGE, R" +
            ...
            "LIKE ? ESCAPE '!' AND PRINCIPAL_TENANT_ID =? AND SP_NAME LIKE ? ESCAPE '!' AND SP_TENANT_ID LIKE ? AND " +
            "STATE LIKE ? ORDER BY ID  ASC LIMIT ? OFFSET ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_ORACLE = "SELECT CONSENT_RECEIPT_ID, LANGUAGE," +
            ...
            ".CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND PRINCIPAL_TENANT_ID = ? " +
            "AND SP_NAME LIKE ? ESCAPE '!' AND " +
    ...
    public static final String SEARCH_RECEIPT_SQL_MSSQL = "SELECT CONSENT_RECEIPT_ID, LANGUAGE, PII_PRINCIPAL_ID, " +
            ...
            ".CONSENT_RECEIPT_ID = RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND " +
            "PRINCIPAL_TENANT_ID = ? AND SP_NAME LIKE ? ESCAPE '!' AND " +
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT = "SELECT R.CONSENT_RECEIPT_ID, R.LANGUAGE, R" +
            ".PII_PRINCIPAL_ID, R.PRINCIPAL_TENANT_ID, R.STATE,RS.SP_DISPLAY_NAME,RS.SP_DESCRIPTION FROM CM_RECEIPT R" +
            " INNER JOIN CM_RECEIPT_SP_ASSOC RS ON R.CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID " +
            "LIKE ? ESCAPE '!' AND PRINCIPAL_TENANT_ID =? AND SP_NAME LIKE ? ESCAPE '!' AND STATE LIKE ? ORDER BY ID" +
            "  ASC LIMIT ? OFFSET ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT_DB2 = "SELECT CONSENT_RECEIPT_ID, LANGUAGE, " +
            ...
            "LIKE ? ESCAPE '!' AND PRINCIPAL_TENANT_ID=? AND RS.SP_NAME LIKE ? ESCAPE '!' AND R.STATE LIKE ?) AS X " +
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT_INFORMIX = "SELECT R.CONSENT_RECEIPT_ID, R" +
            ...
            "PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND PRINCIPAL_TENANT_ID = ? AND SP_NAME LIKE ? ESCAPE '!' AND STATE" +
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT_ORACLE = "SELECT CONSENT_RECEIPT_ID, LANGUAGE," +
            ...
            ".* FROM( SELECT R.CONSENT_RECEIPT_ID, R.LANGUAGE,R.PII_PRINCIPAL_ID,R.PRINCIPAL_TENANT_ID, R.STATE,RS" +
            ".SP_DISPLAY_NAME,RS.SP_DESCRIPTION FROM CM_RECEIPT R INNER JOIN CM_RECEIPT_SP_ASSOC RS ON R" +
            ".CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND PRINCIPAL_TENANT_ID = ? AND " +
            "SP_NAME LIKE ? ESCAPE '!' AND STATE " +
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_PRINCIPLE_TENANT = "SELECT R.CONSENT_RECEIPT_ID, R.LANGUAGE, " +
            ...
            "CM_RECEIPT R INNER JOIN CM_RECEIPT_SP_ASSOC RS ON R.CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE " +
            "PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND SP_NAME LIKE ? ESCAPE '!' AND SP_TENANT_ID = ? AND STATE LIKE " +
            "? ORDER BY ID  ASC LIMIT ? OFFSET ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_PRINCIPLE_TENANT_DB2 =
            ...
            ".PII_PRINCIPAL_ID, R.PRINCIPAL_TENANT_ID, RS.SP_DISPLAY_NAME,RS.SP_DESCRIPTION,R.STATE,ROW_NUMBER() OVER" +
            "( ORDER BY R.CONSENT_RECEIPT_ID) AS ROWNUMBER FROM CM_RECEIPT R INNER JOIN CM_RECEIPT_SP_ASSOC RS ON  R" +
            ".CONSENT_RECEIPT_ID = RS.CONSENT_RECEIPT_ID WHERE R.PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND RS.SP_NAME LIKE" +
            " ? ESCAPE '!' AND RS.SP_TENANT_ID LIKE ? AND R.STATE LIKE ?) AS X WHERE ROWNUMBER BETWEEN ? AND ?";

    public static final String SEARCH_RECEIPT_SQL_WITHOUT_PRINCIPLE_TENANT_INFORMIX =
            "SELECT R.CONSENT_RECEIPT_ID, R.LANGUAGE, R" +
            ".PII_PRINCIPAL_ID, R.PRINCIPAL_TENANT_ID, R.STATE,RS.SP_DISPLAY_NAME,RS.SP_DESCRIPTION FROM CM_RECEIPT R" +
            " INNER JOIN CM_RECEIPT_SP_ASSOC RS ON R.CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID " +
            "LIKE ? ESCAPE '!' AND SP_NAME LIKE ? ESCAPE '!' AND SP_TENANT_ID LIKE ? AND STATE LIKE ? ORDER " +
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_PRINCIPLE_TENANT_ORACLE = "SELECT CONSENT_RECEIPT_ID, LANGUAGE," +
            ...
            ".* FROM( SELECT R.CONSENT_RECEIPT_ID, R.LANGUAGE,R.PII_PRINCIPAL_ID,R.PRINCIPAL_TENANT_ID, R.STATE,RS" +
            ".SP_DISPLAY_NAME,RS.SP_DESCRIPTION FROM CM_RECEIPT R INNER JOIN CM_RECEIPT_SP_ASSOC RS ON R" +
            ".CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND SP_NAME LIKE ? " +
            "ESCAPE '!' AND SP_TENANT_ID LIKE ? AND STATE LIKE ? ORDER BY R.CONSENT_RECEIPT_ID ) A WHERE  ROWNUM <= ? )" +
            " WHERE  RNUM > ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_PRINCIPLE_TENANT_MSSQL =
            ...
            ".CONSENT_RECEIPT_ID) AS ROWNUM FROM CM_RECEIPT R INNER JOIN CM_RECEIPT_SP_ASSOC RS ON R" +
            ".CONSENT_RECEIPT_ID = RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND SP_NAME LIKE ?" +
            " ESCAPE '!' AND SP_TENANT_ID LIKE ? AND STATE LIKE ?) AS RES WHERE RES.ROWNUM BETWEEN ? AND ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT_AND_PRINCIPLE_TENANT = "SELECT " +
            ...
            ".PRINCIPAL_TENANT_ID, R.STATE,RS.SP_DISPLAY_NAME,RS.SP_DESCRIPTION FROM CM_RECEIPT R INNER JOIN " +
            "CM_RECEIPT_SP_ASSOC RS ON R.CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? " +
            "ESCAPE '!' AND SP_NAME LIKE ? ESCAPE '!' AND STATE LIKE ? ORDER BY ID  ASC LIMIT ? OFFSET ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT_AND_PRINCIPLE_TENANT_DB2 =
            ...
            "( ORDER BY R.CONSENT_RECEIPT_ID) AS ROWNUMBER FROM CM_RECEIPT R INNER JOIN CM_RECEIPT_SP_ASSOC RS ON  R" +
            ".CONSENT_RECEIPT_ID = RS.CONSENT_RECEIPT_ID WHERE R.PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND RS.SP_NAME LIKE " +
            "? ESCAPE '!' AND R.STATE LIKE ?) AS X WHERE ROWNUMBER BETWEEN ? AND ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT_AND_PRINCIPLE_TENANT_INFORMIX = "SELECT " +
            ...
            "LIKE ? ESCAPE '!' AND SP_NAME LIKE ? ESCAPE '!' AND STATE LIKE ? ORDER BY ID  ASC LIMIT ? OFFSET ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT_AND_PRINCIPLE_TENANT_ORACLE =
            ...
            ".SP_DISPLAY_NAME,RS.SP_DESCRIPTION FROM CM_RECEIPT R INNER JOIN CM_RECEIPT_SP_ASSOC RS ON R" +
            ".CONSENT_RECEIPT_ID=RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND SP_NAME LIKE ?" +
            " ESCAPE '!' AND STATE LIKE ? ORDER BY R.CONSENT_RECEIPT_ID ) A WHERE  ROWNUM <= ? ) WHERE  RNUM > ?";
    ...
    public static final String SEARCH_RECEIPT_SQL_WITHOUT_SP_TENANT_AND_PRINCIPLE_TENANT_MSSQL = "SELECT " +
            ...
            ".CONSENT_RECEIPT_ID) AS ROWNUM FROM CM_RECEIPT R INNER JOIN CM_RECEIPT_SP_ASSOC RS ON R" +
            ".CONSENT_RECEIPT_ID = RS.CONSENT_RECEIPT_ID WHERE PII_PRINCIPAL_ID LIKE ? ESCAPE '!' AND SP_NAME LIKE ?" +
            " ESCAPE '!' AND STATE LIKE ?) AS RES WHERE RES.ROWNUM BETWEEN ? AND ?";
    ...
    public static final String UPDATE_PII_CATEGORY_UUID_SQL =
            "UPDATE CM_PII_CATEGORY SET UUID = ? WHERE ID = ? AND UUID IS NULL";
    ...
    public static final String GET_PURPOSE_VERSION_BY_VERSION_LABEL_SQL = "SELECT PURPOSE_ID, VERSION, " +
            "DESCRIPTION, TENANT_ID, UUID FROM CM_PURPOSE_VERSION " +
            "WHERE PURPOSE_ID = (SELECT ID FROM CM_PURPOSE WHERE UUID = ?) AND VERSION = ? AND TENANT_ID = ?";
    ...
    public static final String INSERT_PURPOSE_VERSION_PII_CAT_ASSOC_SQL = "INSERT INTO " +
            "CM_PURPOSE_VERSION_PII_CAT_ASSOC (TENANT_ID, PURPOSE_VERSION_ID, CM_PII_CATEGORY_ID, IS_MANDATORY) VALUES (?, ?, ?, ?)";
    ...
    public static final String INSERT_PII_CATEGORY_PROPERTY_SQL =
            "INSERT INTO CM_PII_CATEGORY_PROPERTY (PII_CATEGORY_ID, PROPERTY_KEY, PROPERTY_VALUE, TENANT_ID) " +
            "VALUES (?, ?, ?, ?)";

    public static final String GET_PII_CATEGORY_PROPERTIES_SQL =
            "SELECT PROPERTY_KEY, PROPERTY_VALUE FROM CM_PII_CATEGORY_PROPERTY WHERE PII_CATEGORY_ID = ?";
    ...
    public static final String INSERT_CONSENT_AUTHORIZATION_SQL =
            "INSERT INTO CM_CONSENT_AUTHORIZATION (CONSENT_RECEIPT_ID, USER_ID, STATUS, UPDATED_TIME, TYPE) " +
            "VALUES (?, ?, ?, ?, ?)";
    ...
    public static final String UPDATE_RECEIPT_EXPIRY_SQL =
            "UPDATE CM_RECEIPT SET EXPIRY_TIME = ? WHERE CONSENT_RECEIPT_ID = ?";
