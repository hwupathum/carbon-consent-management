...
import static org.wso2.carbon.consent.mgt.core.constant.SQLConstants.LIST_PAGINATED_PURPOSE_WITH_NAME_MYSQL;
import static org.wso2.carbon.consent.mgt.core.constant.SQLConstants.LIST_PAGINATED_PURPOSE_WITH_NAME_DB2;
import static org.wso2.carbon.consent.mgt.core.constant.SQLConstants.LIST_PAGINATED_PURPOSE_WITH_NAME_ORACLE;
import static org.wso2.carbon.consent.mgt.core.constant.SQLConstants.LIST_PAGINATED_PURPOSE_WITH_NAME_MSSQL;
...
public class PurposeDAOImpl implements PurposeDAO {
    ...
    public List<Purpose> listPurposes(String group, String groupType, String name, int limit, int offset,
        ...
        try {
            ...
            String query;
            if (isH2MySqlOrPostgresDB()) {
                query = LIST_PAGINATED_PURPOSE_WITH_NAME_MYSQL;
            } else if (isDB2DB()) {
                query = LIST_PAGINATED_PURPOSE_WITH_NAME_DB2;
                int initialOffset = offset;
                offset = offset + limit;
                limit = initialOffset + 1;
            } else if (isMSSqlDB()) {
                ...
                offset = limit + offset;
                limit = initialOffset + 1;
                query = LIST_PAGINATED_PURPOSE_WITH_NAME_MSSQL;
            } else {
                query = LIST_PAGINATED_PURPOSE_WITH_NAME_ORACLE;
                limit = offset + limit;
            }
            int finalLimit = limit;
            int finalOffset = offset;
            ...
            purposes = jdbcTemplate.executeQuery(query,
                    ...
                    preparedStatement -> {
                        ...
                        preparedStatement.setString(2, finalGroup);
                        preparedStatement.setString(3, finalGroupType);
                        preparedStatement.setString(4, finalNameFilter);
    ...
    @Override
    public void updateLatestVersionId(int purposeId, String versionUuid, int tenantId) throws ConsentManagementException {

        JdbcTemplate jdbcTemplate = JdbcUtils.getNewTemplate();
        try {
            jdbcTemplate.executeUpdate(UPDATE_PURPOSE_LATEST_VERSION_SQL, preparedStatement -> {
                preparedStatement.setString(1, versionUuid);
